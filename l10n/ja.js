OC.L10N.register(
    ...
    "Error while setting quota." : "容量制限の設定中にエラーが発生しました。",
    "enabled" : "有効",
    "disabled" : "無効",
    "User {uid} has been {state}!" : "ユーザ(uid={uid})は{state}状態です",
    "no group" : "未グループ",
    ...
    "Couldn't send email address change confirmation mail. Please contact your administrator." : "emailアドレス変更の確認メールを送信できませんでした。管理者に問い合わせてください。",
