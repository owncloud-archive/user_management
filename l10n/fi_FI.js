OC.L10N.register(
    ...
    "Error while setting quota." : "Virhe asetettaessa käyttäjän tallennustilaa",
    "enabled" : "Käytössä",
    "disabled" : "Poissa käytöstä",
    "User {uid} has been {state}!" : "Käyttäjä {uid} on asetettu {state}!",
    "no group" : "ei ryhmää",
    ...
    "Couldn't send email address change confirmation mail. Please contact your administrator." : "Ei voitu lähettää sähköpostiosoitteen vaihtamisen vahvistusta. Ole hyvä ja ota yhteyttä järjestelmänvalvojaan.",
    ...
    "Use the following link to confirm your changes to the email address: {link}" : "Käytä oheistä linkkiä vahvistaaksesi muutoksesi sähköpostiosoitteseen: {link}",
    "Email address changed to {mailAddress} successfully." : "Uusi sähköpostiosoite {mailAddress} vaihdettiin onnistuneesti.",
    "Users" : "Käyttäjät",
    "Show enabled/disabled option" : "Näytä käytössä/ei käytössä vaihtoehto",
