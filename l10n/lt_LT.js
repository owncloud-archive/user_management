OC.L10N.register(
    ...
    "Please provide an admin recovery password; otherwise, all user data will be lost." : "Prašome pateikti administratoriaus atstatymo slaptažodį; kitu atveju visi vartotojų duomenys bus prarasti.",
