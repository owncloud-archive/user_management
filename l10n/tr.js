OC.L10N.register(
    ...
    "undo" : "geri al",
    "You are about to delete a group. This action can't be undone and is permanent. Are you sure that you want to permanently delete {groupName}?" : "Bir grubu silmek üzeresiniz. Bu işlem geri alınamaz ve kalıcıdır. {GroupName} uygulamasını kalıcı olarak silmek istediğinize emin misiniz?",
    ...
    "Please provide an admin recovery password; otherwise, all user data will be lost." : "Lütfen bir yönetici kurtarma parolası girin; Aksi takdirde, tüm kullanıcı verileri kaybolacaktır.",
    ...
    "Failed to create activation link. Please contact your administrator." : "Etkinleştirme bağlantı sı oluşturulamadı. Lütfen yöneticinize başvurun.",
    "Can't send email to the user. Contact your administrator." : "Kullanıcı ya e-posta gönderilemiyor. Yöneticinize başvurun.",
    ...
    "Use the following link to confirm your changes to the email address: {link}" : "E-posta adresindeki değişikliklerinizi onaylamak için aşağıdaki bağlantı yı kullanın: {bağlantı}",
    ...
    "The activation link has expired. Click the button below to request a new one and complete the registration." : "Aktivasyon bağlantı sının süresi doldu. Yeni bir tane istemek ve kayıt işlemini tamamlamak için aşağıdaki düğmeye tıklayın.",
