OC.L10N.register(
    ...
    "You are about to delete a group. This action can't be undone and is permanent. Are you sure that you want to permanently delete {groupName}?" : "Du bist dabei, eine Gruppe zu löschen. Dieser Schritt kann nicht rückgängig gemacht werden und ist dauerhaft. Bist du sicher, dass Du {groupName} dauerhaft löschen willst?",
    ...
    "You are about to delete a user. This action can't be undone and is permanent. All user data, files and shares will be deleted. Are you sure that you want to permanently delete {userName}?" : "Du bist dabei einen Benutzer zu löschen. Dieser Schritt kann nicht rückgängig gemacht werden und ist dauerhaft. Alle Benutzerdaten, Dateien und geteilte Daten werden gelöscht. Bist Du sicher, dass Du {userName} dauerhaft löschen möchtest?",
    ...
    "Failed to create activation link. Please contact your administrator." : "Erstellen des Aktivierungslinks fehlgeschlagen. Bitte kontaktiere Deinen Administrator.",
    "Can't send email to the user. Contact your administrator." : "Kann E-Mail nicht an Benutzer versenden. Bitte kontaktiere Deinen Administrator.",
    ...
    "Show password field" : "Zeige das Passwortfeld an",
    "Show quota field" : "Zeige das Kontingent Feld an.",
