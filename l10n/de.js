OC.L10N.register(
    ...
    "You are about to delete a group. This action can't be undone and is permanent. Are you sure that you want to permanently delete {groupName}?" : "Sie sind dabei, eine Gruppe zu löschen. Dieser Schritt kann nicht rückgängig gemacht werden und ist dauerhaft. Sind Sie sicher, dass Sie {groupName} dauerhaft löschen wollen?",
    "Delete group" : "Gruppe löschen",
    "Failed to set password. Please contact your administrator." : "Passwort erstellen fehlgeschlagen. Bitte kontaktieren Sie Ihren Administrator",
    "Delete" : "Löschen",
    "never" : "niemals",
    "deleted {userName}" : "{userName} gelöscht",
    "You are about to delete a user. This action can't be undone and is permanent. All user data, files and shares will be deleted. Are you sure that you want to permanently delete {userName}?" : "Sie sind dabei einen Benutzer zu löschen. Dieser Schritt kann nicht rückgängig gemacht werden und ist dauerhaft. Alle Benutzerdaten, Dateien und geteilte Daten werden gelöscht. Sind Sie sicher, dass Sie {userName} dauerhaft löschen möchten?",
    ...
    "Please provide an admin recovery password; otherwise, all user data will be lost." : "Bitte gib ein Wiederherstellungspasswort für das Administratorkonto an, da sonst alle Benutzerdaten verloren gehen können.",
    ...
    "The token provided had expired." : "Der Token ist abgelaufen",
    "Failed to create activation link. Please contact your administrator." : "Erstellen des Aktivierungslinks fehlgeschlagen. Bitte kontaktieren Sie Ihren Administrator.",
    "Can't send email to the user. Contact your administrator." : "Kann E-Mail nicht an Benutzer versenden. Bitte kontaktieren Sie Ihren Administrator",
    "Failed to set password. Please contact the administrator." : "Passwort erstellen fehlgeschlagen. Bitte kontaktieren Sie Ihren Administrator",
    ...
    "Email has been changed successfully." : "E-Mail Adresse wurde erfolgreich geändert.",
    "An email has been sent to this address for confirmation. Until the email is verified this address will not be set." : "Eine E-Mail ist an diese Adresse zur Bestätigung gesendet worden. Bis diese Email bestätigt wurde, wird diese Adresse nicht verwendet.",
    "No email was sent because you already sent one recently. Please try again later." : "Es wurde keine E-Mail versendet, da bereits eine E-Mail versendet wurde. Bitte später noch einmal versuchen.",
    ...
    "%s email address confirm" : "%s E-Mail Adressbestätigung",
    "Couldn't send email address change confirmation mail. Please contact your administrator." : "Die Bestätigung zur Änderung der E-Mail Adresse konnte nicht versendet werden. Bitte kontaktiere Deinen Administrator.",
    ...
    "Use the following link to confirm your changes to the email address: {link}" : "Benutze den folgenden Link, um die Änderung der E-Mail Adresse zu bestätigen: {link}",
    "Email address changed to {mailAddress} successfully." : "E-Mail Adresse wurde erfolgreich auf {mailAddress} geändert.",
    "Users" : "Benutzer",
    "Show enabled/disabled option" : "Option Aktiviert/Deaktiviert anzeigen",
    ...
    "Set password for new users" : "Passwort für neue Nutzer anlegen",
    "Show email address" : "E-Mail-Adresse anzeigen",
    "Hey there,<br><br>just letting you know that you now have an %s account.<br><br>Your username: %s<br>Please set the password by accessing it: <a href=\"%s\">Here</a><br><br>" : "Hallo,<br><br>hier nur kurz die Mitteilung, dass Du jetzt ein %s-Konto hast.<br><br>Dein Benutzername: %s<br>Bitte erstelle Dein Passwort  <a href=\"%s\"> hier:</a><br><br>",
    ...
    "New Password" : "Neues Passwort",
    "Please set your password" : "Bitte erstellen erstellen Dein Passwort",
