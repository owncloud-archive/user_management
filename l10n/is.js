OC.L10N.register(
    ...
    "Error while setting quota." : "Villa við uppsetningu á kvóta.",
    "enabled" : "virkt",
    "disabled" : "óvirkt",
    "User {uid} has been {state}!" : "Notandi {uid} hefur verið {state}!",
    ...
    "The token provided had expired." : "Teiknið sem þú gafst upp er útrunnið.",
    ...
    "No email was sent because you already sent one recently. Please try again later." : "Enginn póstur var sendur, því stutt er síðan þú sendir annan. Reyndu aftur síðar.",
    ...
    "%s email address confirm" : "Staðfesting á tölvupóstfangi %s",
    "Couldn't send email address change confirmation mail. Please contact your administrator." : "Gat ekki sent staðfestingarpóst fyrir breytingu á tölvupóstfangi. Hafðu samband við kerfisstjóra.",
    ...
    "Set password for new users" : "Setja lykilorð fyrir nýja notendur",
