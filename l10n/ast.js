OC.L10N.register(
    ...
    "Send email to new user" : "Unviar corréu al nuevu usuariu",
    "Show email address" : "Amosar direición de corréu",
    "Hey there,<br><br>just letting you know that you now have an %s account.<br><br>Your username: %s<br>Access it: <a href=\"%s\">%s</a><br><br>" : "Hola, ¿qué hai?,<br><br>namái déxamos dicite qu'agora ties una cuenta %s<br><br>Nome d'usuariu: %s<br>Accede: <a href=\"%s\">%s</a><br><br>",
    "Cheers!" : "¡Salú!",
