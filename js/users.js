...
var UserList = {
	...
	initDeleteHandling: function() {
		...
		$userListBody.on('click', '.delete', function () {
			...
			OC.dialogs.confirm(
				t('user_management', 'You are about to delete a user. This action can\'t be undone and is permanent. All user data, files and shares will be deleted. Are you sure that you want to permanently delete {userName}?', {userName: uid}),
				t('user_management', 'Delete user'),
